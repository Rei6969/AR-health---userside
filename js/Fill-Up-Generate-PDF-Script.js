        ...
        document
          ...
          .addEventListener("submit", async (e) => {
            ...
            try {
              ...
              const inpCourse = document.querySelector(".inp-course").value;
              const inpSchoolYear =
              ...
              form.getTextField("inp-course").setText(inpCourse);
              ...
              const fileStorageRef = storageRef(
                storage,
                `medical-records/${key}/${`${inpSurname}-Medical-Record.pdf`}`
              );
